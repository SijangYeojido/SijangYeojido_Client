        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () async {
                  await data.cancelReservation(widget.reservation.id);
                  if (!mounted) return;
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: isExpired
                            ? [AppColors.divider, AppColors.background]
                            : [
                  ...
                  AppCard(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _InfoRow(
                          label: '점포명',
                          value: widget.reservation.storeName,
                        ),
                        const SizedBox(height: 8),
                        _InfoRow(
                          label: '상품',
                          value: widget.reservation.itemName,
                        ),
                        const SizedBox(height: 8),
                        _InfoRow(
                          label: '수량',
